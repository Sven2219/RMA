    ...
    return (
        <ScrollView style={styles.mainContainer}>
            ...
            <View style={[styles.positionCenter, styles.buttonPadding]}>
                <TouchableOpacity style={[styles.buttonContainer,{backgroundColor:props.isUpdating?colors.updateColor:colors.darkCyan}]} activeOpacity={0.6} onPress={props.handleSubmit}>
                    <Text style={styles.buttonTitle}>
                        {props.isUpdating?I18n.t("update"):I18n.t("addPerson")}
                    </Text>
                </TouchableOpacity>
            </View>
